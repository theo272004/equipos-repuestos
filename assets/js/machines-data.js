        ...
        },
        {
          ...
          systemAtlas: {
            ...
            machineMap: {
              ...
              hotspots: [
                { label: "S4A19100110 · Arrastre de 6 sobres (3 puestos)", target: "transporte", x: 47.99, y: 44.66, w: 2.4, h: 1.8 },
                { label: "S4A26100920 · Correa del portabobinas", target: "alimentacion-bobina", x: 38.4, y: 60.33, w: 2.4, h: 1.8 },
                { label: "S4M95100110 · Fotocélula de lectura de muesca", target: "formado-fotocentrado", x: 38.2, y: 60.25, w: 2.4, h: 1.8 },
                { label: "S4A95100110 · Grupo A95 · control", target: "control", x: 62.31, y: 67.95, w: 2.4, h: 1.8 },
                { label: "S4M17100110 · Guías de desviación del papel", target: "formado-fotocentrado", x: 40.01, y: 48.31, w: 2.4, h: 1.8 },
                { label: "S4A27100110 · Guías de desviación del papel (2.ª línea)", target: "formado-fotocentrado", x: 37.86, y: 50.28, w: 2.4, h: 1.8 },
                { label: "S7A96100120 · Instalación eléctrica de la máquina", target: "control", x: 60.18, y: 69.06, w: 2.4, h: 1.8 },
                { label: "S4A71100310 · Juntas esféricas de mando", target: "transporte", x: 55.95, y: 48.72, w: 2.4, h: 1.8 },
                { label: "S4A19100720 · Mando de la cuchilla horizontal", target: "corte-soldadura", x: 47.99, y: 44.66, w: 2.4, h: 1.8 },
                { label: "S4M02100110 · Motor principal y cadena en baño de aceite", target: "transporte", x: 36.39, y: 58.53, w: 2.4, h: 1.8 },
                { label: "S3A95100310 · PC de la máquina y juntas", target: "control", x: 65.64, y: 35.59, w: 2.4, h: 1.8 },
                { label: "S4M15100110 · Placa de anclaje", target: "corte-soldadura", x: 47.37, y: 45.69, w: 2.4, h: 1.8 },
                { label: "S4M16100110 · Portabobina y empalme (cadena)", target: "alimentacion-bobina", x: 35.48, y: 71.25, w: 2.4, h: 1.8 },
                { label: "S4A26100410 · Portabobinas neumático D500 (eje D=74)", target: "alimentacion-bobina", x: 38.31, y: 75.06, w: 2.4, h: 1.8 },
                { label: "S4A75100610 · Rodillos de reenvío y desviación", target: "formado-fotocentrado", x: 46.18, y: 42.94, w: 2.4, h: 1.8 },
                { label: "S4A21100230 · Soldadura >118 (carro UL ATEX)", target: "corte-soldadura", x: 47.99, y: 44.66, w: 2.4, h: 1.8 },
                { label: "S4M14100110 · Soldadura del papel (placas y mordazas)", target: "corte-soldadura", x: 45.56, y: 43.97, w: 2.4, h: 1.8 },
                { label: "S4A12100110 · Toma de sobres y correa de motorización", target: "formado-fotocentrado", x: 38.4, y: 60.33, w: 2.4, h: 1.8 },
                { label: "S4G72200210 · Válvula estrella doble de dosificación", target: "dosificacion", x: 57.69, y: 50.45, w: 2.4, h: 1.8 }
              ]
            },
            systems: [
